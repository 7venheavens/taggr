...
def main(input_path: Path, output_path: Path, config: Optional[Path], 
         folder_priority: Optional[float], source_preference: Optional[str],
    ...
    OUTPUT_PATH: Directory where organized files will be placed
    """
    try:
        # Load configuration

...
from ..core.models import MatchResult, ConfidenceBreakdown, SourceType, PlexMetadata
...
class ScraperAPIClient:
    ...
    async def search_video(self, video_id: str, source_hint: Optional[SourceType] = None) -> APIResponse:
    ...
    async def search_multiple_ids(self, video_ids: List[str], 
                                source_hint: Optional[SourceType] = None) -> Dict[str, APIResponse]:
...
class MetadataProcessor:
    ...
    def process_search_response(self, api_response: APIResponse, 
                              original_id: str, source_hint: Optional[SourceType] = None) -> Optional[MatchResult]:
    ...
    def _calculate_match_confidence(self, data: Dict, original_id: str, 
                                  source_hint: Optional[SourceType] = None) -> ConfidenceBreakdown:
    ...
    def _determine_source(self, data: Dict, source_hint: Optional[SourceType] = None) -> SourceType:
...
class VideoMatcher:
    ...
    async def match_video(self, primary_id: str, alternative_ids: List[str], 
                         source_hint: Optional[SourceType] = None) -> Optional[MatchResult]:
